...
import static ru.otus.hw07.atm.model.Nominal.*;
...
public class BankATMServiceImpl implements BankATMService {
    ...
    public BankATMServiceImpl() {
        ...
        cassettes.add(new ATMCassette(TEN, 0));
        cassettes.add(new ATMCassette(FIFTY, 0));
        cassettes.add(new ATMCassette(ONE_HUNDRED, 0));
        cassettes.add(new ATMCassette(TWO_HUNDRED, 0));
        cassettes.add(new ATMCassette(FIVE_HUNDRED, 0));
        cassettes.add(new ATMCassette(ONE_THOUSAND, 0));
        cassettes.add(new ATMCassette(TWO_THOUSAND, 0));
        cassettes.add(new ATMCassette(FIVE_THOUSAND, 0));
